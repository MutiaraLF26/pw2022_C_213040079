...
function koneksi() {
    $conn = mysqli_connect('localhost', 'root', '', 'pw2022_c_213040079') or die ('KONEKSI GAGAL');
...
function hapus($id) {
    ...
    // hapus file gambar, kecuali defult
    if($mhs["gamabr"] !== 'orang.jpg') {
...
function ubah($data) {
    ...
    function upload() {
        ...
        // cek apakah file yamg diupload bukan gambar
        ...
        // lolos pengecekan, siap untuk di upload
